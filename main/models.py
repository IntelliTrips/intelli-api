...
class Roteiro(models.Model):
    ...
    partida = models.CharField(max_length=100, choices=CIDADES, null=False, blank=False, default="Partida")
    destino = models.CharField(max_length=100, choices=CIDADES,null=False, blank=False,default="Destino")
